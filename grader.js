...
var checkHtmlFile = function(cheeriofile, checks) {
    $ = cheeriofile;
    var out = {};
...
if(require.main == module) {
    ...
    if (program.url){
	// use restler to get html file from url 
	rest.get(program.url).on('complete', function(data) {
	    var cheeriofile=cheerio.load(data);
	    var checkJson = checkHtmlFile(cheeriofile,checks);
